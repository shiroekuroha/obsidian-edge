...
void Log::init() {
    ...
    s_coreFileLogger = spdlog::rotating_logger_mt("Engine File",
                                                  "logs/engine_file.txt",
                                                  static_cast<unsigned long>(MB_SIZE) * OE_LOG_FILE_MAX_SIZE,
                                                  OE_LOG_FILE_MAX_NUMBER);
    s_coreFileLogger->set_level(spdlog::level::trace);

    s_clientFileLogger = spdlog::rotating_logger_mt("Client File",
                                                    "logs/client_file.txt",
                                                    static_cast<unsigned long>(MB_SIZE) * OE_LOG_FILE_MAX_SIZE,
                                                    OE_LOG_FILE_MAX_NUMBER);
