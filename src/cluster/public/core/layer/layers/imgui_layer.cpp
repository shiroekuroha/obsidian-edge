...
void ImGuiLayer::onAttach() {
    ...
    ImGui_ImplGlfw_InitForOpenGL(Application::get().window().getNative(), true);
...
void ImGuiLayer::onEvent(Event &event) {
    ...
    if (event.isInCategory(EventCategoryKeyboard) & io.WantCaptureKeyboard) {
        dispatcher.dispatch<KeyPressedEvent>([](KeyPressedEvent &event) -> bool {
            ...
            io.AddKeyEvent(glfwKeyToImGuiKey(static_cast<int>(event.getKeyCode()),
                                             glfwGetKeyScancode(static_cast<int>(event.getKeyCode()))),
                           true);
            return true;
        });
    ...
    if (event.isInCategory(EventCategoryMouse) & io.WantCaptureMouse) {
        dispatcher.dispatch<MouseButtonPressedEvent>([](MouseButtonPressedEvent &event) -> bool {
            ...
            io.AddMouseButtonEvent(static_cast<ImGuiMouseButton>(event.getMouseCode()), true);
            return true;
        });
        ...
        dispatcher.dispatch<MouseButtonReleasedEvent>([](MouseButtonReleasedEvent &event) -> bool {
            ...
            io.AddMouseButtonEvent(static_cast<ImGuiMouseButton>(event.getMouseCode()), false);
            return true;
        });
