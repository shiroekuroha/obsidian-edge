...
auto WindowMovedEvent::getLocation() const -> Vector2i { return m_location; }

auto WindowMovedEvent::getX() const -> int { return m_location.x; }

auto WindowMovedEvent::getY() const -> int { return m_location.y; }
...
auto WindowResizedEvent::getSize() const -> Vector2i { return m_size; }

auto WindowResizedEvent::getWidth() const -> int { return m_size.x; }

auto WindowResizedEvent::getHeight() const -> int { return m_size.y; }
