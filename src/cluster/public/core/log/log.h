...
public:
    ...
    static inline auto getCoreLogger() -> std::shared_ptr<spdlog::logger> & { return s_coreLogger; };

    static inline auto getCoreFileLogger() -> std::shared_ptr<spdlog::logger> & { return s_coreFileLogger; };

    static inline auto getClientLogger() -> std::shared_ptr<spdlog::logger> & { return s_clientLogger; };

    static inline auto getClientFileLogger() -> std::shared_ptr<spdlog::logger> & { return s_clientFileLogger; };
