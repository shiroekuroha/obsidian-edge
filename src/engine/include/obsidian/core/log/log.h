...
public:
    ...
    static inline auto
    getCoreLogger () -> SharedPointer<spdlog::logger> &
    {
        return s_coreLogger;
    };

    static inline auto
    getCoreFileLogger () -> SharedPointer<spdlog::logger> &
    {
        return s_coreFileLogger;
    };

    static inline auto
    getClientLogger () -> SharedPointer<spdlog::logger> &
    {
        return s_clientLogger;
    };

    static inline auto
    getClientFileLogger () -> SharedPointer<spdlog::logger> &
    {
        return s_clientFileLogger;
    };

private:
    static SharedPointer<spdlog::logger> s_coreLogger;
    static SharedPointer<spdlog::logger> s_coreFileLogger;
    static SharedPointer<spdlog::logger> s_clientLogger;
    static SharedPointer<spdlog::logger> s_clientFileLogger;
};
}
