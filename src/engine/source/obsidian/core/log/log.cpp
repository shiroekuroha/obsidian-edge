...
{
SharedPointer<spdlog::logger> Log::s_coreLogger;
SharedPointer<spdlog::logger> Log::s_coreFileLogger;
SharedPointer<spdlog::logger> Log::s_clientLogger;
SharedPointer<spdlog::logger> Log::s_clientFileLogger;
