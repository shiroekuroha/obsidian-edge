...
#    include "obsidian/core/window/platform/window_windows.h"
#elif OE_PLATFORM_LINUX
#    include "obsidian/core/window/platform/window_linux.h"
#endif
...
auto
Window::getWidth () const -> unsigned int
{
    return m_data.size.x;
}
auto
Window::getHeight () const -> unsigned int
{
...
auto
Window::isVSync () const -> bool
{
    return m_data.vSync;
}

auto
Window::create (const WindowProps &props) -> Window *
{
#ifdef OE_PLATFORM_WINDOWS
...
auto
Window::get () -> GLFWwindow &
{
    return *m_window;
}

auto
Window::getNative () -> GLFWwindow *
{
    return m_window;
}
} // namespace ObsidianEdge
